...
function Navbar() {
  return (
    <nav className="flex justify-between items-center max-w-6xl mx-auto px-4 bg-white/80 text-white py-4 rounded-xl sticky top-4 tracking-wide md:px-20 shadow-md shadow-gray-300">
